...
def build_classification_head(model, dataset_name, template, data_location, device,poison=0):
...
def get_classification_head(args, dataset,poison=0):
    ...
    classification_head = build_classification_head(model, dataset, template, args.data_location, args.device,poison)
